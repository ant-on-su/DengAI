#!/usr/bin/python
"""
Transformer Objects (to build pandas transformation pipeline)
taken from: https://www.kaggle.com/jankoch/scikit-learn-pipelines-and-pandas
@author: JanKoch: Scikit-learn pipelines and pandas
...
class DataFrameMethodTransformer(BaseEstimator, TransformerMixin):
    """ A DataFrame transformer providing df.method application
    
    Parameters
    ----------
        
    func : df.method to apply to the DataFrame in the pipeline
